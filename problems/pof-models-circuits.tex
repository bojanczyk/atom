...
\mikexercise{\label{of-circuit-to-tree}
    A circuit is called a \emph{formula} if the directed acyclic graph is a tree. Show that every pof circuit can be transformed into an equivalent formula.
}{
...
\mikexercise{\label{of-dnf-circuit-decidable}
    A pof circuit is said to be in DNF form if the root gate is a disjunction, its children are conjunctions, and their children are variables or their negations. Show that satisfiability is decidable for circuits in DNF form.
}{
